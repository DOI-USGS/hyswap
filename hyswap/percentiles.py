...
def calculate_variable_percentile_thresholds_by_day_of_year(
    ...
    **kwargs : dict, optional
    ...
    .. doctest::
        ...
        ...     df=df, data_column_name="value", date_column_name="time")
...
def calculate_fixed_percentile_from_value(value, percentile_df):
    ...
    percentile_df : pd.DataFrame
        ...
        provided manually or from data pulled from the USGS Water Data stats
        service.
    ...
    downloaded from the Water Data APIs.
    ...
    .. doctest::
        ...
        ...     new_data['value'], pcts_df)
        >>> new_data['est_pct'].to_list()
        [47.54, 75.0, 53.55, 55.32, 62.9, 55.65, 50.97]
...
def calculate_multiple_variable_percentiles_from_values(df, data_column_name,
    ...
    records downloaded from the Water Data APIs.
