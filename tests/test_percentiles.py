...
def test_calculate_fixed_percentile_thresholds_by_day():
    """Test the calculate_fixed_percentile_thresholds_by_day function."""
    # make a dataframe
    df = pd.DataFrame({
        'data': np.arange(101),
        'date': pd.date_range('2019-01-01', '2019-04-11')})
    # test the function
    percentiles_ = percentiles.calculate_fixed_percentile_thresholds_by_day(
